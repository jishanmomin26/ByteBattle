        ...
        <div className="mt-12 sm:mt-16 grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <ScrollReveal delay={0.2}>
            <div className="glass-card p-6 sm:p-8 md:p-10">
              ...
              <div className="space-y-5 text-gray-300 text-sm sm:text-base leading-7 sm:leading-8 text-center lg:text-left">
                ...
                <div className="mt-6 border border-purple-500/30 bg-purple-500/5 rounded-2xl p-4 sm:p-5">
